...
<div class="card">
          ...
          <h3 class="text-center mb-4 pb-2 text-black"><b>EASY 4 STEPS TO FOLLOW</b><div class="horizontal-line"></div><h4 class="text-center mb-4 pb-2 text-black">The easiest way to order computer parts. PC builder provides the user a platform<br> to build and deliver their parts within minutes of browsing.</h4></h3>
      ...
      <div class="md-stepper-horizontal orange">
        ...
        <div class="md-step active">
            ...
            <div class="md-step-title">Choose an item/s<br><br>We've got you covered with items <br> from various supplier online </div>
            <div class="md-step-bar-left"></div>
            <div class="md-step-bar-right"></div>
          </div>
        <div class="md-step active">
          ...
          <div class="md-step-title">Pickup/Delivery<br><br>Future Delivered on time, <br> come and choose method of pickup</div>
          <div class="md-step-bar-left"></div>
          <div class="md-step-bar-right"></div>
        </div>
        <div class="md-step active">
          ...
          <div class="md-step-title">Payment<br><br>We accept payments<br> with cash and credit</div></div>
          <div class="md-step-bar-left"></div>
          <div class="md-step-bar-right"></div>
        </div>
      </div>
        ...
        <!-- ITEM TESTING END-->
                ...
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal2">
                        ...
                        <img class="img-fluid" src="<?php echo base_url().'public/uploads/items/thumb/2.jpg';?>" alt="..." />
                        <div class="card">
                            <div class="card-body">
                ...
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal3">
                        ...
                        <img class="img-fluid" src="<?php echo base_url().'public/uploads/items/thumb/3.jpg';?>" alt="..." />
                        <div class="card">
                            <div class="card-body">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                <p>
                ...
                <!-- Portfolio Item 4-->
                <h2 class="page-section-heading text-white text-uppercase text-secondary mb-0">NEW RELEASE</h2>
            <!-- Icon Divider-->
            <div class="divider-custom">
                ...
                <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
                    <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal4">
                        ...
                        <img class="img-fluid" src="<?php echo base_url().'public/uploads/items/thumb/4.jpg';?>" alt="..." />
                        <div class="card">
                            <div class="card-body">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                <p>
                ...
                <div class="col-md-6 col-lg-4 mb-5 mb-md-0">
                    <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal5">
                        ...
                        <img class="img-fluid" src="<?php echo base_url().'public/uploads/items/thumb/5.jpg';?>" alt="..." />
                        <div class="card">
                            <div class="card-body">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                <p>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <h3 class="portfolio-modal-title text-secondary text-uppercase mb-0">Intel Core i5</h3>
                                <!-- Icon Divider-->
                                <div class="divider-custom">
                                ...
                                <img class="img-fluid rounded mb-5" src="./images/1.jpg" alt="..." />
                                <!-- Portfolio Modal - Text-->
                                <p class="mb-4">Intel Core i5 9400 6C/6T 2.9-4.1ghz 9mb, UHD630 65W LGA1151, Tray, No Cooler</p>
                ...
                <div class="modal-body text-center pb-5">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <!-- Portfolio Modal - Title-->
                                <h3 class="portfolio-modal-title text-secondary text-uppercase mb-0">Intel Core i9</h3>
                                <!-- Icon Divider-->
                                <div class="divider-custom">
                                    <div class="divider-custom-line"></div>
                                    <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
                                ...
                                <!-- Portfolio Modal - Image-->
                                <img class="img-fluid rounded mb-5" src="./images/2.jpg" alt="..." />
                                <!-- Portfolio Modal - Text-->
                                <p class="mb-4">Intel Core i9 9980XE 18C/36T 3.0-4.4ghz 25mb 165W LGA2066, Box -- REQUIRED to : buy with compatible motherboard</p>
                ...
                <div class="modal-body text-center pb-5">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <!-- Portfolio Modal - Title-->
                                <h3 class="portfolio-modal-title text-secondary text-uppercase mb-0">AMD Ryzen 3</h3>
                                <!-- Icon Divider-->
                                <div class="divider-custom">
                                    <div class="divider-custom-line"></div>
                                    <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
                                ...
                                <!-- Portfolio Modal - Image-->
                                <img class="img-fluid rounded mb-5" src="./images/3.jpg" alt="..." />
                                <!-- Portfolio Modal - Text-->
                                <p class="mb-4">AMD Ryzen 3 3200G 4C/4T AM4, Tray, Free Wraith Stealth Cooler -- LESS 495, IF bought with PC set : PHP 9500</p>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <!-- Portfolio Modal - Image-->
                                <img class="img-fluid rounded mb-5" src="./images/4.jpg" alt="..." />
                                <!-- Portfolio Modal - Text-->
                                <p class="mb-4"></p>
                ...
                <div class="modal-body text-center pb-5">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <!-- Portfolio Modal - Title-->
                                <h3 class="portfolio-modal-title text-secondary text-uppercase mb-0">Pentium Gold</h3>
                                <!-- Icon Divider-->
                                <div class="divider-custom">
                                    <div class="divider-custom-line"></div>
                                    <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
                                ...
                                <!-- Portfolio Modal - Image-->
                                <img class="img-fluid rounded mb-5" src="./images/5.jpg" alt="..." />
                                <!-- Portfolio Modal - Text-->
                                <p class="mb-4"></p>
                ...
                <div class="modal-body text-center pb-5">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <!-- Portfolio Modal - Title-->
                                <h3 class="portfolio-modal-title text-secondary text-uppercase mb-0">COLORFUL FAN</h3>
                                <!-- Icon Divider-->
                                <div class="divider-custom">
                                    <div class="divider-custom-line"></div>
                                    <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
                                ...
                                <!-- Portfolio Modal - Image-->
                                <img class="img-fluid rounded mb-5" src="./images/6.jpg" alt="..." />
                                <!-- Portfolio Modal - Text-->
                                <p class="mb-4"></p>
              ...
              <div class="col-lg-3 col-xs-12 links">
                <h3 class="mt-lg-0 mt-sm-3 text-uppercase fw-bold">Links</h3>
                  <ul class="m-0 p-0">
                    ...
                    <li><a href="<?php echo base_url()."index.php/users/register"?>">Sign Up</a></li>
                  </ul>
              </div>
